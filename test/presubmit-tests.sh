...
projects="catalogs commit-status-tracker generators helm hub oci octant-plugin pipeline/cleanup sample-custom-task scheduler sdk task-loops tekdoc webhooks-extension"
