...
projects="catalogs cel commit-status-tracker generators helm hub oci octant-plugin pipeline/cleanup  pipelines-in-pipelines tekdoc task-loops notifiers/github-app"
