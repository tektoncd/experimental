...
projects="catalogs cel commit-status-tracker generators helm hub oci octant-plugin pipeline/cleanup tekdoc task-loops webhooks-extension pipelines-in-pipelines"
