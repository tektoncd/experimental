...
import (
	...
	"github.com/tektoncd/experimental/pipeline-loops/pkg/client/clientset/versioned/scheme"
...
func (c *CustomV1alpha1Client) PipelineLoops(namespace string) PipelineLoopInterface {
	return newPipelineLoops(c, namespace)
}
