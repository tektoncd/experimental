...
import (
	...
	"github.com/tektoncd/experimental/metrics-operator/pkg/client/clientset/versioned/scheme"
...
func (c *MonitoringV1alpha1Client) TaskMonitors(namespace string) TaskMonitorInterface {
