...
import (
	...
	taskmonitor "github.com/tektoncd/experimental/metrics-operator/pkg/client/injection/informers/monitoring/v1alpha1/taskmonitor"
	zap "go.uber.org/zap"
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	taskmonitorInformer := taskmonitor.Get(ctx)

	lister := taskmonitorInformer.Lister()
