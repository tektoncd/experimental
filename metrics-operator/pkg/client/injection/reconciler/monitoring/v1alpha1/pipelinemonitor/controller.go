...
import (
	...
	pipelinemonitor "github.com/tektoncd/experimental/metrics-operator/pkg/client/injection/informers/monitoring/v1alpha1/pipelinemonitor"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "pipelinemonitor-controller"
	defaultFinalizerName       = "pipelinemonitors.metrics.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	pipelinemonitorInformer := pipelinemonitor.Get(ctx)

	lister := pipelinemonitorInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "metrics.tekton.dev.PipelineMonitor"),
	)
