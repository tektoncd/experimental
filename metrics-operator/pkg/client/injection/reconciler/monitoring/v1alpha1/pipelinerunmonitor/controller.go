...
import (
	...
	versionedscheme "github.com/tektoncd/experimental/metrics-operator/pkg/client/clientset/versioned/scheme"
	client "github.com/tektoncd/experimental/metrics-operator/pkg/client/injection/client"
	pipelinerunmonitor "github.com/tektoncd/experimental/metrics-operator/pkg/client/injection/informers/monitoring/v1alpha1/pipelinerunmonitor"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "pipelinerunmonitor-controller"
	defaultFinalizerName       = "pipelinerunmonitors.metrics.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	pipelinerunmonitorInformer := pipelinerunmonitor.Get(ctx)

	lister := pipelinerunmonitorInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "metrics.tekton.dev.PipelineRunMonitor"),
	)
