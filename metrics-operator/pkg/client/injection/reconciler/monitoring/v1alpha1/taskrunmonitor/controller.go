...
import (
	...
	taskrunmonitor "github.com/tektoncd/experimental/metrics-operator/pkg/client/injection/informers/monitoring/v1alpha1/taskrunmonitor"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "taskrunmonitor-controller"
	defaultFinalizerName       = "taskrunmonitors.metrics.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	taskrunmonitorInformer := taskrunmonitor.Get(ctx)

	lister := taskrunmonitorInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "metrics.tekton.dev.TaskRunMonitor"),
	)
