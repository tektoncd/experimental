...
func TestDoesMonitorExist(t *testing.T) {
	...
	// we will cheat and use webhook name as the webhook name as a prefix
...
// 	monitorBindingName, err := r.getMonitorBindingName(hook.GitRepositoryURL, hook.PullTask)
// 	if err != nil {
// 		t.Errorf("Error in TestCreateBindings: %s", err.Error())
// 	}

// 	hookBinding, monitorBinding, err := r.createBindings(hook, monitorBindingName)
// 	if err != nil {
// 		t.Errorf("Error in TestCreateBindings: %s", err.Error())
// 	}

// 	t.Errorf("%s", hookBinding)
// 	t.Errorf("%s", monitorBinding)
// }
