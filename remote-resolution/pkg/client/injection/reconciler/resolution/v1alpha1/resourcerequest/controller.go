...
import (
	...
	versionedscheme "github.com/tektoncd/experimental/remote-resolution/pkg/client/clientset/versioned/scheme"
	client "github.com/tektoncd/experimental/remote-resolution/pkg/client/injection/client"
	resourcerequest "github.com/tektoncd/experimental/remote-resolution/pkg/client/injection/informers/resolution/v1alpha1/resourcerequest"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "resourcerequest-controller"
	defaultFinalizerName       = "resourcerequests.resolution.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	resourcerequestInformer := resourcerequest.Get(ctx)

	lister := resourcerequestInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "resolution.tekton.dev.ResourceRequest"),
	)
