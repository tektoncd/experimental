...
import (
	...
	versionedscheme "github.com/tektoncd/experimental/concurrency/pkg/client/clientset/versioned/scheme"
	client "github.com/tektoncd/experimental/concurrency/pkg/client/injection/client"
	concurrencycontrol "github.com/tektoncd/experimental/concurrency/pkg/client/injection/informers/concurrency/v1alpha1/concurrencycontrol"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "concurrencycontrols.custom.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "custom.tekton.dev.ConcurrencyControl"),
	)
