...
type reconcilerImpl struct {
	...
	Lister concurrencyv1alpha1.ConcurrencyControlLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister concurrencyv1alpha1.ConcurrencyControlLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ConcurrencyControl) (*v1alpha1.ConcurrencyControl, error) {
	...
	patcher := r.Client.ConcurrencyV1alpha1().ConcurrencyControls(resource.Namespace)
