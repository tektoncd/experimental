...
type FakeConcurrencyControls struct {
	Fake *FakeConcurrencyV1alpha1
	ns   string
}

var concurrencycontrolsResource = schema.GroupVersionResource{Group: "concurrency", Version: "v1alpha1", Resource: "concurrencycontrols"}

var concurrencycontrolsKind = schema.GroupVersionKind{Group: "concurrency", Version: "v1alpha1", Kind: "ConcurrencyControl"}
