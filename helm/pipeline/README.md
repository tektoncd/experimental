...
Current chart version is `0.11.2`
...
| `controller.image.tag` | string | Controller docker image tag | `"v0.11.2"` |
...
| `version` | string | Tekton pipelines version used to add labels on deployments, pods and services | `"v0.11.2"` |
...
| `webhook.image.tag` | string | Webhook docker image tag | `"v0.11.2"` |
