...
import (
	...
	externalversions "github.com/tektoncd/experimental/task-loops/pkg/client/informers/externalversions"
	client "github.com/tektoncd/experimental/task-loops/pkg/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/tektoncd/experimental/task-loops/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
