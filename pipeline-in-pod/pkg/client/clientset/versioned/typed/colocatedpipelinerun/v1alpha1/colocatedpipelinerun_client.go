...
func (c *TektonV1alpha1Client) ColocatedPipelineRuns(namespace string) ColocatedPipelineRunInterface {
	return newColocatedPipelineRuns(c, namespace)
}
