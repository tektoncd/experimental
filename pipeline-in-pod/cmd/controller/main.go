...
func main() {
	ctx := filteredinformerfactory.WithSelectors(signals.NewContext(), v1beta1.ManagedByLabelKey)
	...
	sharedmain.MainWithContext(ctx, pipelineinpod.ControllerName, pipelineinpod.NewController(opts))
}
