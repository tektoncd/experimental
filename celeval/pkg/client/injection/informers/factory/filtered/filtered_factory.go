...
import (
	...
	externalversions "github.com/tektoncd/experimental/celeval/pkg/client/informers/externalversions"
	client "github.com/tektoncd/experimental/celeval/pkg/client/injection/client"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/tektoncd/experimental/celeval/pkg/client/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
