...
import (
	...
	"github.com/tektoncd/experimental/celeval/pkg/client/clientset/versioned/scheme"
...
func (c *CustomV1alpha1Client) CELEvals(namespace string) CELEvalInterface {
	return newCELEvals(c, namespace)
}
