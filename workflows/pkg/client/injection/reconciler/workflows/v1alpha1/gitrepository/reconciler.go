...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.GitRepository, desired *v1alpha1.GitRepository) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.WorkflowsV1alpha1().GitRepositories(desired.Namespace)
		...
		updater := r.Client.WorkflowsV1alpha1().GitRepositories(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GitRepository, desiredFinalizers sets.String) (*v1alpha1.GitRepository, error) {
	...
	patcher := r.Client.WorkflowsV1alpha1().GitRepositories(resource.Namespace)
