...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.Workflow, desired *v1alpha1.Workflow) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.TektonV1alpha1().Workflows(desired.Namespace)
		...
		updater := r.Client.TektonV1alpha1().Workflows(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Workflow, desiredFinalizers sets.String) (*v1alpha1.Workflow, error) {
	...
	patcher := r.Client.TektonV1alpha1().Workflows(resource.Namespace)
