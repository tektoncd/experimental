...
type TektonListenerSpec struct {
	...
	PipelineRunSpec *pipelinev1alpha1.PipelineRunSpec `json:"runspec"`
...
type TektonListenerStatus struct {
	...
	// +optional
	Results *pipelinev1alpha1.Results `json:"results,omitempty"`
	// map of PipelineRunTaskRunStatus with the taskRun name as the key
	// +optional
	PipelineRuns map[string]*pipelinev1alpha1.PipelineRunStatus `json:"pipelineRuns,omitempty"`
