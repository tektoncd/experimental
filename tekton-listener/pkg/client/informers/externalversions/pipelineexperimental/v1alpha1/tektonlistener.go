	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PipelineexperimentalV1alpha1().TektonListeners(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PipelineexperimentalV1alpha1().TektonListeners(namespace).Watch(options)
			},
		},
		&pipelineexperimentalv1alpha1.TektonListener{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tektonListenerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pipelineexperimentalv1alpha1.TektonListener{}, f.defaultInformer)
}
